...
parser.add_argument("--task", default="super_resolution", choices=["denoising", "inpatining", "super_resolution"], type=str, dest="task")
...
parser.add_argument("--network", default = "resnet", choices=["unet", "resnet", "autoencoder", "srresnet"], type=str, dest="network")
